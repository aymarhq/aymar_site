...
export default function Site({ dict }: { dict: Dict }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const sections = gsap.utils.toArray<HTMLElement>('.studio, .work-editorial, .process-layout, .how-intro, .specialist-content, .contact-content');
