...
export const pt: Dict = {
  ...
  work: { eyebrow: '02 páginas e ofertas com a PKG', editorialBefore: 'Páginas de vendas, campanhas e ofertas feitas para apresentar melhor o produto e aumentar a intenção de compra, em parceria com a ', editorialLink: 'Agência PKG', editorialAfter: '.', hover: 'Passe o mouse para ver o projeto, clique para abrir.', preview: 'abrir projeto' },
