...
export const pt: Dict = {
  ...
  contact: { eyebrow: '06 contato', title: 'Tem uma operação', emphasis: 'para arrumar?', paragraph: 'Escreva direto: conte qual processo está travado e o que você já tentou. Uma pessoa de verdade responde em até dois dias úteis.', whatsapp: 'Falar no WhatsApp', orLabel: 'OU', response: 'RESPOSTA EM ATÉ 2 DIAS ÚTEIS', instagram: 'instagram', pkg: 'parceria pkg', brief: 'enviar briefing' },
