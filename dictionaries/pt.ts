...
export type Dict = {
  ...
  contact: { eyebrow: string; title: string; emphasis: string; paragraph: string; whatsapp: string; orLabel: string; response: string; instagram: string; brief: string };
